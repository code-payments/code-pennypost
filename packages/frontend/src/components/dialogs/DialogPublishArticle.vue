            ...
            <div class="mt-5 sm:mt-10">
              <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                  ...
                  focus-visible:outline-indigo-600" @click="publish()">
                    ...
                    <svg v-if="publishing" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  ring-gray-200 hover:bg-gray-50 sm:mt-0"
                  @click="close()">
                  Nevermind</button>

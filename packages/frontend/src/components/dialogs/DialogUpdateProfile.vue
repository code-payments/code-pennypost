...
<template>
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="relative z-50" @close="no()">
          ...
          <TransitionChild as="template" enter="ease-out duration-300"
            ...
            <div class="mt-5 sm:mt-10">
              <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                ...
                focus-visible:outline-indigo-600 sm:col-start-2" @click="yes()">
                Update</button>
                ...
                ring-gray-200 hover:bg-gray-50 sm:col-start-1 sm:mt-0"
                @click="no()">
                Nevermind</button>
              </div>
            </div>
